...
rm ~/Nextcloud/GitHub/Bookmarks/Bookmarks/nohup.out
...
notify-send -i ~/.icons/GitHub-Symbolic-16.svg "GitHub" "Bookmarks updated."
echo -e "${GREEN}Bookmarks updated.${NC}" && sleep 1
