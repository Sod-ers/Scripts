...
# System package
# /opt/Obsidian/obsidian %U obsidian://vault/Weekly-Planner/Task-Manager-e-matrix

# App image
# ~/Programs/Obisidan/Obsidian.AppImage obsidian://vault/Weekly-Planner/Task-Manager-e-matrix
