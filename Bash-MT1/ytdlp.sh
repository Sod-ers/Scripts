...
mkdir ~/Videos/YouTube/ 2> /dev/null
mkdir ~/Videos/VODs/ 2> /dev/null
touch ~/Videos/VODs/do-not-delete.txt
touch ~/Videos/YouTube/do-not-delete.txt
echo "1" > ~/Videos/YouTube/do-not-delete.txt
echo "1" > ~/Videos/VODs/do-not-delete.txt
...
do
    case $opt in
        ...
        *) echo "invalid option $REPLY";;
        ...
        "Playlist")
export PS3=$'\033[0;31mSelect an option: \e[0m'
options=("Sorted" "Random" "Set Playlist URL" "Go Back")
select opt in "${options[@]}"
do
    case $opt in
        "Sorted")
            ...
            ;;
        "Random")
            ~/.local/bin/ytdlp --match-filter '!was_live & original_url!*=/shorts/' $binge_playlist_url --config-locations ~/Configs/YTDLP/youtube-video-1080p.conf --playlist-random --max-downloads 5 --sponsorblock-remove sponsor,selfpromo --sleep-interval 60 --max-sleep-interval 120 --js-runtimes deno:/home/soders/.deno/bin/deno --download-archive ~/Configs/YTDLP/watch-history.txt
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
...
do
    case $opt in
        "Recent")
            ~/.local/bin/ytdlp $watch_later_playlist_url --config-locations ~/Configs/YTDLP/youtube-video-1080p.conf --lazy-playlist --max-downloads 5 --sponsorblock-remove sponsor,selfpromo --sleep-interval 60 --max-sleep-interval 120 --js-runtimes deno:/home/soders/.deno/bin/deno --download-archive ~/Configs/YTDLP/watch-history.txt
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
        "Random")
            ~/.local/bin/ytdlp $watch_later_playlist_url --config-locations ~/Configs/YTDLP/youtube-video-1080p.conf --playlist-random --max-downloads 5 --sponsorblock-remove sponsor,selfpromo --sleep-interval 60 --max-sleep-interval 120 --js-runtimes deno:/home/soders/.deno/bin/deno --download-archive ~/Configs/YTDLP/watch-history.txt
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
        ...
        *) echo "invalid option $REPLY";;
        ...
        "Videos")
export PS3=$'\033[0;31mSelect an option: \e[0m'
options=("Videos" "Playlist" "Channel" "Music Videos" "Sample" "Audio Only" "Go Back")
select opt in "${options[@]}"
do
    case $opt in
        "Videos")
...
do
    case $opt in
        "Recent")
            read -p "$(echo -e ${RED}"Enter URLs: "${NC})" URLS
            ~/.local/bin/ytdlp $URLS --sponsorblock-remove sponsor,selfpromo --sleep-interval 60 --max-sleep-interval 120 --js-runtimes deno:/home/soders/.deno/bin/deno --config-locations ~/Configs/YTDLP/youtube-video-1080p.conf --lazy-playlist
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
        "Random")
            read -p "$(echo -e ${RED}"Enter URLs: "${NC})" URLS
            ~/.local/bin/ytdlp $URLS --sponsorblock-remove sponsor,selfpromo --sleep-interval 60 --max-sleep-interval 120 --js-runtimes deno:/home/soders/.deno/bin/deno --config-locations ~/Configs/YTDLP/youtube-video-1080p.conf --playlist-random
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
...
do
    case $opt in
        "Recent")
            read -p "$(echo -e ${RED}"Enter URLs: "${NC})" URLS
            ~/.local/bin/ytdlp $URLS --config-locations ~/Configs/YTDLP/youtube-video-1080p.conf --lazy-playlist --sponsorblock-remove sponsor,selfpromo --sleep-interval 60 --max-sleep-interval 120 --js-runtimes deno:/home/soders/.deno/bin/deno
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
        "Random")
            read -p "$(echo -e ${RED}"Enter URLs: "${NC})" URLS
            ~/.local/bin/ytdlp $URLS --config-locations ~/Configs/YTDLP/youtube-video-1080p.conf --playlist-random --sponsorblock-remove sponsor,selfpromo --sleep-interval 60 --max-sleep-interval 120 --js-runtimes deno:/home/soders/.deno/bin/deno
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
        ...
        *) echo "invalid option $REPLY";;
        ...
        "Audio Only")
            read -p "$(echo -e ${RED}"Enter URLs: "${NC})" URLS
            ~/.local/bin/ytdlp $URLS --config-locations ~/Configs/YTDLP/audio.conf
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
        "Go Back")
...
do
    case $opt in
        "Recent VODs")
            ~/.local/bin/ytdlp --match-filter "!is_live" -a ~/Configs/YTDLP/twitch-following-channel-urls.txt --config-locations ~/Configs/YTDLP/twitch-video-1080p.conf --playlist-end 1 --lazy-playlist --dateafter now-7days --js-runtimes deno:/home/soders/.deno/bin/deno --download-archive ~/Configs/YTDLP/watch-history.txt
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
...
do
    case $opt in
        "Recent VODs")
            ~/.local/bin/ytdlp --match-filter "!is_live" -a ~/Configs/YTDLP/twitch-bedtime-channel-urls.txt --config-locations ~/Configs/YTDLP/twitch-video-1080p.conf --playlist-end 1 --lazy-playlist --dateafter now-7days --js-runtimes deno:/home/soders/.deno/bin/deno --max-downloads 1 --download-archive ~/Configs/YTDLP/watch-history.txt
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
        ...
        *) echo "invalid option $REPLY";;
        ...
        "VOD")
            ...
            ~/.local/bin/ytdlp $URLS --config-locations ~/Configs/YTDLP/twitch-video-1080p.conf --js-runtimes deno:/home/soders/.deno/bin/deno
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
        ...
        *) echo "invalid option $REPLY";;
        ...
        "Generic Videos")
            read -p "$(echo -e ${RED}"Enter URLs: "${NC})" URLS
            ~/.local/bin/ytdlp $URLS --config-locations ~/Configs/YTDLP/generic-video.conf --js-runtimes deno:/home/soders/.deno/bin/deno
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
