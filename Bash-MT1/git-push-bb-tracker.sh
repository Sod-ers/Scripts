...
rm ~/Nextcloud/GitHub/BB-Tracker/BB-Tracker/nohup.out
...
notify-send -i ~/.icons/GitHub-Symbolic-16.svg "GitHub" "BB Tracker updated."
echo -e "${GREEN}BB Tracker updated.${NC}" && sleep 1
