...
echo " " >> /dev/usb/lp1
echo " " >> /dev/usb/lp2
cat /home/soders/Documents/Notes/Print.md >> /dev/usb/lp0
cat /home/soders/Documents/Notes/Print.md >> /dev/usb/lp1
cat /home/soders/Documents/Notes/Print.md >> /dev/usb/lp2
