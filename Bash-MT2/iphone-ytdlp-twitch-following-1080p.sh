...
~/.local/bin/ytdlp --match-filter "!is_live" $twitch_following --config-locations ~/Configs/YTDLP/twitch-following-1080p.conf --playlist-end 2 --lazy-playlist --dateafter now-3days --max-downloads 1 > /dev/null 2>&1&