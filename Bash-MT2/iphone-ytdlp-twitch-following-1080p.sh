...
/home/soders/.local/bin/ytdlp-twitch-following-1080p --match-filter "!is_live" $twitch_bedtime --playlist-end 2 --lazy-playlist --dateafter now-3days --max-downloads 1 > /dev/null 2>&1&
