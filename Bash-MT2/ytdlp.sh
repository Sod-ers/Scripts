...
do
    case $opt in
        "Recent")
            ~/.local/bin/ytdlp --match-filter '!was_live & original_url!*=/shorts/' $binge_channel_url --config-locations ~/Configs/YTDLP/youtube-video-480p.conf --lazy-playlist --max-downloads 5 --sponsorblock-remove sponsor,selfpromo --download-archive ~/Configs/YTDLP/watch-history.txt
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
        "Random")
            ~/.local/bin/ytdlp --match-filter '!was_live & original_url!*=/shorts/' $binge_channel_url --config-locations ~/Configs/YTDLP/youtube-video-480p.conf --playlist-random --max-downloads 5 --sponsorblock-remove sponsor,selfpromo --download-archive ~/Configs/YTDLP/watch-history.txt
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
...
do
    case $opt in
        "Sorted")
            ~/.local/bin/ytdlp --match-filter '!was_live & original_url!*=/shorts/' $binge_playlist_url --config-locations ~/Configs/YTDLP/youtube-video-480p.conf --lazy-playlist --max-downloads 5 --sponsorblock-remove sponsor,selfpromo --download-archive ~/Configs/YTDLP/watch-history.txt
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
        "Random")
            ~/.local/bin/ytdlp --match-filter '!was_live & original_url!*=/shorts/' $binge_playlist_url --config-locations ~/Configs/YTDLP/youtube-video-480p.conf --playlist-random --max-downloads 5 --sponsorblock-remove sponsor,selfpromo --download-archive ~/Configs/YTDLP/watch-history.txt
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
...
do
    case $opt in
        "Recent")
            ~/.local/bin/ytdlp $watch_later_playlist_url --config-locations ~/Configs/YTDLP/youtube-video-480p.conf --lazy-playlist --max-downloads 5 --sponsorblock-remove sponsor,selfpromo --download-archive ~/Configs/YTDLP/watch-history.txt
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
        "Random")
            ~/.local/bin/ytdlp $watch_later_playlist_url --config-locations ~/Configs/YTDLP/youtube-video-480p.conf --playlist-random --max-downloads 5 --sponsorblock-remove sponsor,selfpromo --download-archive ~/Configs/YTDLP/watch-history.txt
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
...
do
    case $opt in
        "1080p")
            ...
            ~/.local/bin/ytdlp $URLS --sponsorblock-remove sponsor,selfpromo --config-locations ~/Configs/YTDLP/youtube-video-1080p.conf
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
        "480p")
            read -p "$(echo -e ${RED}"Enter URLs: "${NC})" URLS
            ~/.local/bin/ytdlp $URLS --sponsorblock-remove sponsor,selfpromo --config-locations ~/Configs/YTDLP/youtube-video-480p.conf
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
...
do
    case $opt in
        "Recent")
            read -p "$(echo -e ${RED}"Enter URLs: "${NC})" URLS
            ~/.local/bin/ytdlp $URLS --sponsorblock-remove sponsor,selfpromo --config-locations ~/Configs/YTDLP/youtube-video-480p.conf --lazy-playlist
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
        "Random")
            read -p "$(echo -e ${RED}"Enter URLs: "${NC})" URLS
            ~/.local/bin/ytdlp $URLS --sponsorblock-remove sponsor,selfpromo --config-locations ~/Configs/YTDLP/youtube-video-480p.conf --playlist-random
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
...
do
    case $opt in
        "1080p")
            ...
            ;;
        "480p")
            ~/.local/bin/ytdlp --match-filter '!is_live' -a ~/Configs/YTDLP/twitch-bedtime-channel-urls.txt --config-locations ~/Configs/YTDLP/twitch-video-480p.conf --playlist-end 1 --lazy-playlist --dateafter now-7days --max-downloads 1 --download-archive ~/Configs/YTDLP/watch-history.txt
            ~/Scripts/delete-empty-media-directories.sh && ~/Scripts/delete-empty-media-directories-2.sh
            ~/Scripts/completion-chime.sh && sleep 1
            break
            ;;
