...
# .xsessionrc
rsync --progress ~/.xsessionrc /mnt/SD-64/Linux/MT3/

# .profile
rsync --progress ~/.profile /mnt/SD-64/Linux/MT3/

# traymd
mkdir /mnt/SD-64/Linux/MT3/traymd/
rsync --progress ~/.config/traymd/config.ini /mnt/SD-64/Linux/MT3/traymd/
rsync -r --progress ~/.local/share/traymd/notes /mnt/SD-64/Linux/MT3/traymd/

# mpv
mkdir /mnt/SD-64/Linux/MT3/mpv/
rsync --progress ~/.config/mpv/mpv.conf /mnt/SD-64/Linux/MT3/mpv/
