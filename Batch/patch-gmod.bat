...
cd E:\GitHub\Derma-Github-Theme
git pull https://github.com/JWalkerMailly/Derma-Github-Theme.git
XCOPY /y /q /s "E:\GitHub\Derma-Github-Theme" "C:\Program Files (x86)\Steam\steamapps\common\GarrysMod\garrysmod\addons\Derma-Github-Theme\"
